...
const NOT_FROM_PROTOTYPE: Record<string, string> = {
  ...
  "hand.title": "Antoine 2026-09-25 — « chantiers », the CEO's word",
  "hand.hintPick": "Antoine 2026-09-25 — say that two is the team's capacity",
  "hand.hintReady": "Antoine 2026-09-25 — same",
  "visio.hangUp": "Antoine 2026-09-25 — the cards appear only once hung up, so the button says so",
  "hand.unlocked": "Antoine 2026-09-25 — the survey unlocks the data review, visibly",
  "report.driversHeading": "Antoine 2026-09-25 — why churn moved",
  "report.drivers.*": "Antoine 2026-09-25 — same",
  "report.driverLine": "Antoine 2026-09-25 — same",
  "effects.insight": "Antoine 2026-09-25 — the answers come in at the quarter's end",
  "events.surveyAnswers": "Antoine 2026-09-25 — same",
