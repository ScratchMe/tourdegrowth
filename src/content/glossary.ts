...
export const GLOSSARY: Record<GlossaryTermId, GlossaryEntry> = {
  ...
  referral: {
    ...
    related: ["viral-coefficient", "growth-loop", "nps", "aarrr"],
  },
  revenue: {
  ...
  "viral-coefficient": {
    ...
    related: ["referral", "growth-loop", "north-star-metric", "nps"],
  ...
  "upsell-cross-sell": {
    ...
    related: ["revenue", "churn", "pql", "nrr-grr"],
  },
  "growth-loop": {
    ...
    related: ["referral", "viral-coefficient", "acquisition", "product-led-growth"],
  },
  "north-star-metric": {
  ...
  "product-led-growth": {
    ...
    related: ["acquisition", "pql", "time-to-value", "growth-loop"],
  },
  arpu: {
    ...GLOSSARY_TERMS.arpu,
