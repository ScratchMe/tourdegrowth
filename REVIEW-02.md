...
| **C — Contenu de référence** | R2-11 | Glossaire : 76 à 105 mots par terme, contre 600 à 1 500 chez ceux qui rangent | F | L | Relecture (lourde) | **Lots 1 à 3 faits** (PR #80 : `cac`, `ltv`, `churn` ; PR #81 : `retention`, `activation`, `viral-coefficient` ; PR #82 : `acquisition`, `referral`, `revenue` — 770 à 950 mots par terme en EN, 910 à 1 115 en FR, 2026-09-06). Les cinq piliers et les quatre termes commerciaux sont couverts ; restent `aarrr`, `aha-moment`, `onboarding`, `growth-loop`, `north-star-metric`, `upsell-cross-sell` (lots 4 et 5) ; premier jet à relire ligne à ligne |
