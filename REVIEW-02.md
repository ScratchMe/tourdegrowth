...
| | R2-21 | Deep dive : deux requêtes concurrentes génèrent deux fois | T | S | Auto | **Fait** (PR #67, 2026-09-06) — l'écriture est protégée ; la double génération reste possible, voir CLAUDE.md |
| | R2-22 | Basic Auth admin : comparaison non constante, `atob` Latin-1 | T | XS | Auto | **Fait** (PR #67, 2026-09-06) |
