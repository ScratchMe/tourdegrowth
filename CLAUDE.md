...
| Bons à tirer nº7 (jeu) et nº8 (moteur) | Toute la copie des deux est marquée `TODO: à relire` ; le nº6 (la copie existante revue) est publié. Construire les deux suivants depuis `grep -rn "TODO: à relire" src/content/game src/content/engine-*` | Avant d'ouvrir le jeu ou le moteur. |
