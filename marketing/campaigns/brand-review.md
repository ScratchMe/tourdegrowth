...
| 4 | Trois anecdotes inventées dans le build log du jeu (« a tester said », « players keep looking at them », un ancien libellé de carte cité mot pour mot) | `game/indiehackers.md`, puis `game/show-hn.md` | Haute (IH lit des récits : une anecdote fausse est un mensonge) | Remplacées par les décisions réelles de GAME-BRIEF §4 ; titre passé de « playtesting taught me » à « things I changed » | Corrigé — dans `show-hn.md` seulement le 2026-09-25 (le premier passage n'avait corrigé que le build log), avec « the risk we playtested for » |
...
| 16 | « nothing you choose is sent » / « rien n'est envoyé » pour le jeu, alors que `src/lib/game/events.ts` envoie l'ordre du DG suivi ou refusé et la fin atteinte | `game/show-hn.md`, `game/social.md`, `game/newsletter.md`, `README.md` | **Haute** (sur le lancement dont le message est l'éthique, la réponse « Does it track me? » était vérifiable et fausse) | La FAQ nomme ces libellés fixes ; ailleurs, « ta partie reste dans ton navigateur » | Corrigé (revue du 2026-09-25) |
| 17 | « rien n'est envoyé » pour le moteur, qui envoie une liste fermée de noms d'événements | `engine/directories.md`, `engine/newsletter.md` | Haute (même promesse, même vérification possible) | « nothing you type is sent » / « Tes chiffres ne quittent pas ton navigateur » | Corrigé (revue du 2026-09-25) |
| 18 | « He names one specific project he wants » chaque trimestre : aucun ordre au premier | `game/indiehackers.md` | Moyenne | « from the second one he names… » | Corrigé (revue du 2026-09-25) |
| 19 | La FAQ disait que la version anglaise « ajoute le cas américain » (les deux langues ont les mêmes cas) et citait l'art. 25 du DSA, que le catalogue ne présente plus comme la règle applicable | `game/show-hn.md`, FAQ | Juridique | Liste des articles réellement cités par le catalogue ; cas américain « dans les deux langues » | Corrigé (revue du 2026-09-25) |
