...
> - **You can win clean.** An earlier version had no good option and testers said there was nothing to be proud of. There are now three honest endings, including one where you hit the target without a single trick — if you bring your data to the CEO.
...
| **"Isn't this a tutorial for manipulation?"** | That's the risk we playtested for. Every trick is paid for in December, the catalogue gives the law behind each one, and the best ending is the honest one. If anyone finishes it thinking the tricks pay, tell me which ending you got. |
...
| **"Why France-specific law?"** | The law cited is French and EU — three-click cancellation (Consumer Code, art. L215-1-1, since June 2023) and the DSA's ban on deceptive interfaces for online platforms (art. 25). The English version explains it for a non-French reader and adds the US case where one exists. |
...
| **"Does it track me?"** | Cookie-less GoatCounter: page views plus a fixed list of event names (level started, quarter played, ending reached, catalogue opened). No account, no identifier, nothing you choose is sent. The list is in the source. |
