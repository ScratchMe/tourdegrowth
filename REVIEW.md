...
|---|---|---|---|---|---|
| **A — Stopper les dégâts sur les données réelles** | R-01 | Deep dive : jeton de propriétaire | F+T | S/M | En cours |
| | R-02 | Ne plus exposer `freeContext`/`contextAnswers` dans la page publique | T | XS | En cours |
...
**Type** F+T · **Effort** S/M · **Statut** En cours
...
**Type** T · **Effort** XS · **Statut** En cours
